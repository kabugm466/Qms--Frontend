...
const NAV_ITEMS = [
  { label: "Overview",            path: "/institution/overview",  icon: "⊞" },
  { label: "Appointments",        path: "/institution/appointments", icon: "📅" },
  { label: "Queue Management",    path: "/institution/queue",     icon: "≋" },
  { label: "Services",            path: "/institution/services",  icon: "🛠" },
  { label: "Institution Profile", path: "/institution/profile",   icon: "🏢" },
];
    ...
    <div className="flex h-screen overflow-hidden font-poppins">
      ...
      <aside className="w-40 bg-navy flex flex-col flex-shrink-0">
        ...
        <div className="px-3 pt-4 pb-3 border-b border-white/10">
          <div className="w-8 h-8 bg-green-brand rounded-lg flex items-center justify-center text-white text-xs font-bold mb-2">
            CGH
          </div>
